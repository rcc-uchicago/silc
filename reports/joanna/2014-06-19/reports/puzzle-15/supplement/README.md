...
This directory contains files relating to the `puzzle-15-supplement` transcripts.  The transcript data in `data.tsv` supplements the `puzzle-15` dataset.

Joanna Schiffman writes:

> Unfortunately, we just discovered that we made a mistake and left four subjects' transcripts out of the file for the 15-puzzle that I sent you. We are going to have to get reports somehow for these 4 subjects.  
